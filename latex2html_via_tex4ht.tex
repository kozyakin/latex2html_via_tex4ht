...
With resent versions of \texttt{GhostScript} ($>$=10.02.0) in your \LaTeX{}
system and \texttt{dvipdfmx} ($<$3.1.1), \texttt{tex4th} creates a corrupted
...
recovered when \texttt{dvipdfmx} version $>$=3.1.1 will be installed in your
